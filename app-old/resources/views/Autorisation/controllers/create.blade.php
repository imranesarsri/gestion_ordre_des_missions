...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col">
                    <h1>{{ __('Autorisation/controllers/message.addController') }}</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title"> <i class="fas fa-gamepad nav-icon"></i>
                                {{ __('Autorisation/controllers/message.add') }}</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('controllers.store') }}" method="POST">
                                ...
                                <button type="submit"
                                    class="btn btn-info">{{ __('Autorisation/controllers/message.add') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
